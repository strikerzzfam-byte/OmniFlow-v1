...
const VariantPanel: React.FC<VariantPanelProps> = React.memo(({
  variants,
  selectedVariant,
  onVariantSelect,
  onSmartAction,
  ...
  }, [editMode, selectedVariant?.content]);
  ...
  return (
    <div className="h-full glass border-l border-glass-border/50 flex flex-col overflow-hidden scrollbar-none">
      {/* Header */}
